...
export function handleSync(event: Sync): void {
    ...
    pactSwap!.totalLiquidityBNB = pactSwap!.totalLiquidityBNB.minus(pair!.trackedReserveBNB as BigDecimal);
    ...
    const t0DerivedBNB = findBnbPerToken(token0 as Token);
    token0!.derivedBNB = t0DerivedBNB;
    token0!.derivedUSD = t0DerivedBNB.times(bundle!.bnbPrice);
    token0!.save();

    const t1DerivedBNB = findBnbPerToken(token1 as Token);
    ...
    pactSwap!.totalLiquidityBNB = pactSwap!.totalLiquidityBNB.plus(trackedLiquidityBNB);
    pactSwap!.totalLiquidityUSD = pactSwap!.totalLiquidityBNB.times(bundle!.bnbPrice);
...
export function handleMint(event: Mint): void {
    ...
    pactSwap!.totalTransactions = pactSwap!.totalTransactions.plus(ONE_BI);
...
export function handleSwap(event: Swap): void {
    ...
    pactSwap!.totalVolumeBNB = pactSwap!.totalVolumeBNB.plus(trackedAmountBNB);
    ...
    const pancakeDayData = updatePactSwapDayData(event);
