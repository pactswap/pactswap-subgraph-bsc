...
export function updatePactSwapDayData(event: ethereum.Event): PactSwapDayData {
    let pancake = PactSwapFactory.load(FACTORY_ADDRESS);
    ...
    if (pactSwapDayData === null) {
        ...
        pactSwapDayData.dailyVolumeBNB = ZERO_BD;
        pactSwapDayData.totalVolumeUSD = ZERO_BD;
        pactSwapDayData.totalVolumeBNB = ZERO_BD;
        pactSwapDayData.dailyVolumeUntracked = ZERO_BD;
    }
    pactSwapDayData.totalLiquidityUSD = pancake.totalLiquidityUSD;
    pactSwapDayData.totalLiquidityBNB = pancake.totalLiquidityBNB;
    pactSwapDayData.totalTransactions = pancake.totalTransactions;
